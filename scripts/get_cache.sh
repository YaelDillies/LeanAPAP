...
if wget https://oleanstorage.azureedge.net/mathlib/LeanAPAP/"$(git rev-parse HEAD)".tar.xz 2> /dev/null; then
  echo "Found oleans at https://oleanstorage.azureedge.net/mathlib/LeanAPAP/"
